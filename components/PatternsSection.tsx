...
const PatternsSection: React.FC<SectionProps> = ({ onBack, profile }) => {
    const topicTitle = Topic.Patterns;
        ...
        <div>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg text-center">
                ...
                <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
                    This section is all about finding and creating patterns. Are you ready to test your skills? Pick a quiz!
                </p>
